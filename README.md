...
- **Have studied and played with:** [Idris](https://www.idris-lang.org/), Haskell, [Elixir](https://elixir-lang.org/)
- **Testing:** Beyond traditional unit testing, I have used and explored [property-based testing](https://en.wikipedia.org/wiki/Software_testing#Property_testing) across multiple languages
...
- **DIY Electronics:** Assembly and soldering of Eurorack modules and designed and built a custom rack for my eurorack modular system
